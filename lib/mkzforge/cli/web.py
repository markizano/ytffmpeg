...
from mkzforge import getLogger, webserv

log = getLogger(__name__)

def serveTheWeb(cfg: dict):
    '''
    Main entry point for 'mkzforge serve' command.
    ...
    try:
        ...
        default_webroot = str(resources.files('mkzforge').joinpath('../../web'))
    ...
    log.info(f'Starting mkzforge web server on http://0.0.0.0:{http_port}')
